...
public class SpidermanProgressBarUi extends BasicProgressBarUI {
    BufferedImage bimage = null;

    public SpidermanProgressBarUi() {
        try {
            bimage = ImageIO.read(Objects.requireNonNull(this.getClass().getResource("/background.png")));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        return new SpidermanProgressBarUi();
    }
    ...
    protected void paintIndeterminate(Graphics g2d, JComponent c) {
        ...
        Icon vectorIcon = velocity > 0 ? (Icons.SPIDERMAN_HEAD) : (Icons.REVERSE_SPIDERMAN_HEAD);

        vectorIcon.paintIcon(progressBar, g, offset2 - JBUIScale.scale(3), -JBUIScale.scale(-2));
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        Icons.SPIDERMAN.paintIcon(progressBar, g2, amountFull - JBUIScale.scale(5), -JBUIScale.scale(1));
        g2.translate(0, -(c.getHeight() - h) / 2);
